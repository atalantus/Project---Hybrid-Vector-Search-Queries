...
int main(int argc, char **argv) {
  ...
  switch(argc) {
    case 4: knn_save_path = string(argv[3]);
    case 3: query_path = string(argv[2]);
    case 2: source_path = string(argv[1]);
    case 1: break;
    default: cout << "./tester [source_path] [query_path] [output_path]\n"; exit(1);
  }
